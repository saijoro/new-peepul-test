...
const assets = {
  "/_build/.vite/manifest.json": {
    ...
    "etag": "\"3cf-ZvqeL9Rp4kBEHzwCik5Z8aF+KkA\"",
    "mtime": "2025-03-21T12:34:55.207Z",
    "size": 975,
  ...
  "/_build/assets/client-BSCZA4RC.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"40642-bUktX2M5Lm2Ya38qNrgxbfTrXM4\"",
    "mtime": "2025-03-21T12:34:55.214Z",
    "size": 263746,
    "path": "../public/_build/assets/client-BSCZA4RC.js"
  },
  "/_build/assets/client-CGHWgZYW.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"3f-dvoKQ2j6UFqBYRbKxd43SRcwL2w\"",
    "mtime": "2025-03-21T12:34:55.207Z",
    "size": 63,
    "path": "../public/_build/assets/client-CGHWgZYW.js"
  },
  "/_build/assets/index-BrWfQbk4.js": {
    "type": "text/javascript; charset=utf-8",
    "etag": "\"176-SGxrUEzpJoOnMmunMKxZb+lvq2s\"",
    "mtime": "2025-03-21T12:34:55.207Z",
    "size": 374,
    "path": "../public/_build/assets/index-BrWfQbk4.js"
  }
};
...
const _mDvpFq = eventHandler((event) => {
...
}), Z = () => ({ routes: { __root__: { filePath: "__root.tsx", children: ["/"], preloads: ["/_build/assets/client-CGHWgZYW.js", "/_build/assets/client-BSCZA4RC.js"] }, "/": { filePath: "index.tsx" } } });
function X(e) {
...
function Y() {
  ...
  t.assets = t.assets || [];
  let a = "";
  const n = X("client"), o = (_a = n.inputs[n.handler]) == null ? void 0 : _a.output.path;
...
const S = createRootRoute({ head: () => ({ meta: [{ charSet: "utf-8" }, { name: "viewport", content: "width=device-width, initial-scale=1" }, { title: "TanStack Start Starter" }] }), component: K });
function K() {
  return jsx(L, { children: jsx(Outlet, {}) });
}
...
async function Q(e, t, a) {
  ...
  if (isPlainObject$1(o) && o.method) {
    ...
    const b = await a(e, { method: r.method, headers: f, signal: r.signal, ...V(r) }), m = await g(b);
...
const ee = (e, t) => {
  const a = `/${q(t)}/${e}`;
  return Object.assign((...o) => Q(a, o, async (s, c) => {
...
export { ee as e, nodeServer as n, w };
